		...
		<div class="col-md-3">
			...
			<section class="main row">
		        		...
		        		<div class="btn-group-vertical ">
		        			...
		        			<a href="<?php URL ?>indexU.php?enlace=nuevo" type="button" class="btn btn-lg btn-info bt-6">Cargar Nuevo Proyecto</a>
		        			
		        			
								          				<a href="" class="dropdown-toggle btn btn-lg btn-primary bt-6" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $_SESSION['login']['usuario'];?>  Salir<span class="caret"></span></a>
