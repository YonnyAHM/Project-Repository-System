...
<div class="container-fluid">
	...
	$user = new EstudianteController();
	if(isset($_POST['reg_user']))
	{
		$r = $user->add($_POST['inputNombre'], $_POST['inputNombre_secun'], $_POST['inputApellido'], $_POST['inputApellido_secun'], $_POST['inputCedula'], $_POST['inputFecha_n'], $_POST['inputDireccion'], $_POST['inputCorreo'], $_POST['inputCorreo_secun'],  $_POST['inputTelefono'], $_POST['inputTelefono_secun'], $_POST['inputPeriodo_esc'], $_POST['inputSemestre'], $_POST['inputPass']);
		if($r)
		{
			echo "<script>alert('Estudiante Registrado, ya puede iniciar seción'); 
...
?>
	...
	<div class="container">
		<div class="form-group col-md-12"></div>
				...
				<h1><center><img src="public/images/icon0.png" class="img2">
				<br>
				Registro de Estudiante </center></h1>
		...
		<fieldset>
					...
					<form class="form-horizontal" method="POST">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="inputPeriodo_esc">Periodo Escolar de Inicio:</label>
							<div class="col-md-4">
								<input class="form-control" id="inputPeriodo_esc" type="text" name="inputPeriodo_esc" placeholder="Ingrese el Periodo en el Cual Usted Inicio AQUI..." required></input>
							</div>
						</div>

						<div class="form-group">
							<label class="control-label col-md-4" for="inputSemestre">Semestre que Cursa:</label>
							<div class="col-md-4">
								<input class="form-control" id="inputSemestre" type="text" name="inputSemestre" placeholder="Ingresre el Semestre que esta Cursando AQUI..." required></input>
							</div>
						</div>
						...
						<br>
						<center><input name="reg_user" type="submit" class="btn btn-lg btn-primary bt-6" value="Registrarse"></center>
